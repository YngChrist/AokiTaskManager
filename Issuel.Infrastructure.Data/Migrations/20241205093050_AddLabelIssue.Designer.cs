...
namespace Issuel.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241205093050_AddLabelIssue")]
    partial class AddLabelIssue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Task.Domain.Entities.Issue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Task.Domain.Entities.Label", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Task.Domain.Entities.Label", b =>
                {
                    b.HasOne("Task.Domain.Entities.Issue", null)
                        .WithMany("Labels")
